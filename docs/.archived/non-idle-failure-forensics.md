...
> **Affected targets:**
> - `intel-agency/workflow-orchestration-queue-hotel41-b` run `23415797162` (2026-03-23)
...
|---|------|--------|------------|---------------|-----------------|-------------------------|
| 1 | `intel-agency/workflow-orchestration-queue-hotel41-b` | `23415797162` | 2026-03-23 00:07 | Token validation failure | `GH_ORCHESTRATION_AGENT_TOKEN is missing required scopes: read:org` | Same-repo run rejected a narrower-but-usable token path instead of falling back to `GITHUB_TOKEN` |
...
- Workflow run `23415797162` logs (`intel-agency/workflow-orchestration-queue-hotel41-b`)
