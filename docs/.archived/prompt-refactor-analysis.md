...
|---|---|---|---|
| `.github/workflows/orchestrator-agent.yml` | `workflow-orchestration-queue-hotel41-b` | A, D | **DONE** |
| `.github/workflows/prompts/orchestrator-agent-prompt.md` | `workflow-orchestration-queue-hotel41-b` | B, D | **DONE** |
| `.github/.labels.json` | `workflow-orchestration-queue-hotel41-b` | C, D, L | **DONE** |
