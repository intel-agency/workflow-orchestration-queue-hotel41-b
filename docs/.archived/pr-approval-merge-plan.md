...
**Locations to update:**
- The orchestrator prompt template in `workflow-orchestration-queue-hotel41-b` (e.g., `scripts/prompt.ps1`, `orchestrator-supervisor.md`, or the assembled prompt).
...
| Orchestrator prompt (TBD exact file) | workflow-orchestration-queue-hotel41-b | Define 4-step loop |
