...
>
> **Scope:** Template repo `workflow-orchestration-queue-hotel41-b` only. Issues targeting generated code (sentinel, notifier, queue) are deferred to the implementation phase.
